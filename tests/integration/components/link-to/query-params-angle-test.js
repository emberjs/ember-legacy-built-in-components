...
moduleFor(
  ...
  class extends ApplicationTestCase {
    ...
    async ['@test it populates href with fully supplied query param values, but without @route param']() {
      this.addTemplate(
        'index',
        `<LinkTo @query={{hash foo='2' bar='NAW'}}>QueryParams</LinkTo>`
      );
...
//       this.addTemplate(
//         'index',
//         `<LinkTo id='the-link' @route='index'>Index</LinkTo>`
//       );
...
//       this.addTemplate(
//         'index',
//         `<LinkTo id='the-link' @query={{hash}}>Index</LinkTo>`
//       );
...
//     async ['@test it updates controller QP properties on current route when invoked'](
//       assert
//     ) {
//       this.addTemplate(
//         'index',
...
//       assert.equal(
//         this.$('#good-link').length,
//         1,
//         'good-link should be in the DOM'
//       );
//       assert.equal(
//         this.$('#bad-link').length,
//         1,
//         'bad-link should be in the DOM'
//       );
...
//     async ['@test href updates when unsupplied controller QP props change'](
//       assert
//     ) {
//       this.addTemplate(
//         'index',
...
//     async ['@test it applies activeClass when query params are not changed'](
//       assert
//     ) {
//       this.addTemplate(
//         'index',
...
//     async ['@test it applies active class when query-param is a number'](
//       assert
//     ) {
//       this.addTemplate(
//         'index',
...
//     async ['@test it applies active class when query-param is an array'](
//       assert
//     ) {
//       this.addTemplate(
//         'index',
...
//     async ['@test it defaults query params while in active transition regression test'](
//       assert
//     ) {
//       this.router.map(function () {
//         this.route('foos');
...
//       this.addTemplate(
//         'foo.bar',
//         `<LinkTo id='baz-link' @route='foo.bar.baz'>Baz</LinkTo>`
//       );
