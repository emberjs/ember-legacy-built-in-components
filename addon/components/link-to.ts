...
const LinkComponent = EmberComponent.extend({
  ...
  */
  ...
  _route: computed(
    'route',
    '_currentRouterState',
    function computeLinkToComponentRoute(this: any) {
      let { route } = this;
  ...
  _models: computed(
    'model',
    'models',
    function computeLinkToComponentModels(this: any) {
      ...
      if (model !== UNDEFINED) {
        ...
        assert(
          'The `@models` argument must be an array.',
  ...
  */
  active: computed(
    'activeClass',
    '_active',
    function computeLinkToComponentActiveClass(this: any) {
  ...
  **/
  ...
  _modelsAreLoaded: computed(
    '_models',
    function computeLinkToComponentModelsAreLoaded(this: any) {
